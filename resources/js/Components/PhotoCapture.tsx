...
export default function PhotoCapture({
  ...
  const [capabilities, setCapabilities] = useState<CameraCapabilities | null>(
    null
  );
    ...
    >
      ...
      <div className='px-6 py-4 bg-gray-50'>
        <p className='text-sm text-gray-600'>
          Position the window in the frame and tap the capture button to take a
          photo.
          {capabilities.hasMultipleCameras &&
            ' Use the switch button to change cameras.'}
        </p>
      </div>
    </div>
  );
