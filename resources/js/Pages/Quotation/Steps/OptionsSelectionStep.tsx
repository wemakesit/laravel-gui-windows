...
export default function OptionsSelectionStep({
  ...
  const getOptionNames = window => {
    ...
    const optionIds = Array.isArray(window.options)
      ? window.options
      : [window.options];
            ...
            <div className='flex'>
              ...
              <div className='ml-3'>
                <p className='text-sm text-yellow-700'>
                  Options allow you to create different combinations of windows
                  in your quotation. Each window can be assigned to one or more
                  options.
                </p>
              </div>
            </div>
