...
import { CheckCircleIcon, DocumentTextIcon, EyeIcon, PlusIcon, HomeIcon } from '@heroicons/react/24/outline';
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-8">
      ...
      <div className="bg-white shadow-lg rounded-lg overflow-hidden">
        ...
        <div className="px-6 py-4 border-b border-gray-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-900">{estimate.customerDetails.address}</p>
            </div>
          </div>
          {estimate.customerDetails.additional_info && (
            <div className="mt-4">
              <p className="text-sm font-medium text-gray-700">Additional Information</p>
              <p className="text-sm text-gray-900">{estimate.customerDetails.additional_info}</p>
            </div>
          )}
        </div>
        ...
        {/* Windows Breakdown */}
        <div className="px-6 py-4 border-b border-gray-200">
          <h3 className="text-lg font-medium text-gray-900 mb-4">Windows & Configuration</h3>
              ...
              <div key={window.id} className="bg-gray-50 rounded-lg p-4">
                <div className="flex justify-between items-start mb-3">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Quantity: {window.quantity}</p>
                  </div>
                  <div className="text-right">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
            ...
            <div>
              ...
              <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
                {estimate.status === 'completed' ? 'Completed' : estimate.status}
              </span>
            </div>
          </div>
        </div>
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-blue-700">
                <p>
                  This estimate is ready to be synced to the server when you're online.
                </p>
              </div>
            </div>
          </div>
