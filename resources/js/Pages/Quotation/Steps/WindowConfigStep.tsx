...
export default function WindowConfigStep({
    ...
    return (
        <div className="space-y-6">
            ...
            <p className="text-gray-600">Configure your windows with glass specifications and finishes.</p>

            {windows.length === 0 ? (
                <div className="text-center py-8 bg-gray-50 rounded-lg">
                    <p className="text-gray-500">No windows added yet. Please add windows in the previous step.</p>
                </div>
            ) : (
                    ...
                    <table className="min-w-full divide-y divide-gray-200">
                        <thead className="bg-gray-50">
                            <tr>
                                ...
                                <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Glass</th>
                                <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Paint</th>
                            ...
                            {windows.map((window, index) => (
                                <tr key={index}>
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                        {window.glass_specification || <span className="text-red-500">Not set</span>}
                                    </td>
                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                        {window.paint_finish || <span className="text-red-500">Not set</span>}
                                    </td>
                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                        {window.hardware_finish || <span className="text-red-500">Not set</span>}
                                    </td>
